...
class trapecija  {
    ...
    public function __construct ($x, $y, $height, $width1, $width2) {
        $startPointX = ($height2 - $height1)/2;
        $startPointY = $y-$height;

        new Rectangle($height, $width1, $this->startPointX, $this->startPointY, 'lime');
    }
...
$trapecija = new trapecija (400, 500, 300, 200, 300  );
